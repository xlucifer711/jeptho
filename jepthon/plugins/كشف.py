...
async def fetch_info(replied_user, event):
    ...
    rotbat = "⌁ من مطورين السورس 𓄂𓆃 ⌁" if user_id == 5190136458 or user_id == 1050898456 or user_id == 1001132193 or user_id == 5092041118 or user_id == 627658332 or user_id == 1833610203 else ("⌁ العضـو 𓅫 ⌁")
    rotbat = "⌁ مـالك الحساب 𓀫 ⌁" if user_id == (await event.client.get_me()).id and user_id != 5190136458  else rotbat
    caption = "✛━━━━━━━━━━━━━✛\n"
